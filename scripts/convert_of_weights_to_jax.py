...
#
# Converts OpenComplex .pt checkpoints into AlphaFold .npz ones, which can then be
...
from opencomplex.utils.tensor_utils import tree_map
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "of_pt_path", type=str, help="Path to OpenComplex .pt checkpoint file"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--template_npz_path", 
        type=str, 
        default="opencomplex/resources/params/params_model_1_ptm.npz",
