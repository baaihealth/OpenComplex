...
def model_config(
    ...
    if "rna" in name:
        c = copy.deepcopy(config_rna)
    elif "multimer" in name:
        c = copy.deepcopy(config)
        c.update(config_multimer_diffs)
    else:
        c = copy.deepcopy(config)
    ...
    # INFERENCE PRESETS
        ...
        c.model.evoformer_stack.no_blocks = 16
        # c.data.train.crop_size = 128
        # c.data.train.crop_size = None
        c.data.train.crop_size = 150
...
config_multimer_diffs = mlc.ConfigDict(
    {
        "data": {
            "common": {
                "feat": {
                    ...
                    "atom14_gt_exists": [NUM_FULL_RES, None],
                    "rigidgroups_gt_frames": [NUM_FULL_RES, None, None, None],
                    "rigidgroups_group_exists": [NUM_FULL_RES, None],
                    "atom14_alt_gt_exists": [NUM_FULL_RES, None],
                    "backbone_rigid_tensor": [NUM_FULL_RES, None, None],
                    "pseudo_beta": [NUM_FULL_RES, None],
                    "atom14_alt_gt_positions": [NUM_FULL_RES, None, None],
                    "backbone_rigid_mask": [NUM_FULL_RES],
                    ...
                    "atom14_gt_positions": [NUM_FULL_RES, None, None],
                    "atom14_atom_is_ambiguous": [NUM_FULL_RES, None],
                },
                "unsupervised_features":
