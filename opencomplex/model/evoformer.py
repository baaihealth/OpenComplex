...
from opencomplex.model.dropout import DropoutRowwise, DropoutColumnwise
from opencomplex.model.msa import (
...
from opencomplex.utils.checkpointing import checkpoint_blocks, get_checkpoint_fn
from opencomplex.utils.chunk_utils import chunk_layer, ChunkSizeTuner
from opencomplex.utils.tensor_utils import add
...
class PairTransformerBlock(nn.Module):
    def __init__(self,
        c_z: int,
        c_hidden_mul: int,
        c_hidden_pair_att: int,
        ...
        super(PairTransformerBlock, self).__init__()
...
class PairTransformerStack(nn.Module):
    """
    Main Evoformer trunk.
        ...
        **kwargs,
        ...
        Args:
            ...
            tune_chunk_size:
                Whether to dynamically tune the module's chunk size
        """
        super(PairTransformerStack, self).__init__()
