...
from opencomplex.data import parsers, mmcif_parsing
from opencomplex.data.errors import Error
from opencomplex.data.tools import kalign
...
def _extract_template_features(
    ...
    templates_butype = residue_constants.sequence_to_onehot(
    ...
    return (
        {
            ...
            "template_butype": np.array(templates_butype),
    ...
    def get_templates(
        ...
        for i in idx:
            ...
            try:
                ...
                print (f"[- error] missing template files exception, {ex}")
                continue
