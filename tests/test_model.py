...
from opencomplex.utils.tensor_utils import tree_map, tensor_tree_map
...
class TestModel(unittest.TestCase):
    def test_dry_run(self):
        ...
        batch["butype"] = torch.argmax(batch["target_feat"], dim=-1)
    ...
    def test_compare(self):
        ...
        batch["butype"] = batch["butype"].long()
        batch["template_butype"] = batch["template_butype"].long()
