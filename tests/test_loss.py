...
from opencomplex.utils.rigid_utils import (
    Rotation,
    Rigid,
)
...
class TestLoss(unittest.TestCase):
    ...
    def test_between_residue_bond_loss_compare(self):
        def run_brbl(pred_pos, pred_atom_mask, residue_index, butype):
    ...
    def test_find_structural_violations_compare(self):
        ...
        batch = {
            ...
            "residue_index": np.arange(n_res),
            "butype": np.random.randint(0, 20, (n_res,)),
    ...
    def test_tm_loss_compare(self):
        ...
        model = compare_utils.get_global_pretrained_opencomplex()
