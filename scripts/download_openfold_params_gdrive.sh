...
#
# Downloads and unzips OpenComplex parameters from Google Drive. Alternative to
# the HuggingFace version.
#
# Usage: bash download_opencomplex_params_gdrive.sh /path/to/download/directory
set -e
...
FILENAME="opencomplex_params_07_22.tar.gz"
