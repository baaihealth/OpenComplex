...
if [[ -d opencomplex/resources/params ]]; then
    ln -s opencomplex/resources/params "${DOWNLOAD_DIR}/params"
    ln -s opencomplex/resources/opencomplex_params "${DOWNLOAD_DIR}/opencomplex_params"
fi
